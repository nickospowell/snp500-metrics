...
financials_filtered |>
  ggplot(aes(x = price_book, y = fct_reorder(sector, price_book,
                                             .na_rm = TRUE))) +
  geom_boxplot() + scale_x_continuous(breaks = seq(0, 20, by = 2)) +
